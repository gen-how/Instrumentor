...
private:
  Instrumentor() : profile_count_(0), is_active_(false) {}
...
public:
  ...
  InstrumentorTimer(const InstrumentorTimer&) = delete;
  InstrumentorTimer& operator=(const InstrumentorTimer&) = delete;
